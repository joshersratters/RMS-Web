...
namespace RMS_Web
{
    public sealed partial class MainPage : Page
    {
        ...
        private void HolidaysAppBarButton_Click(object sender, RoutedEventArgs e)
        {
            WebViewControl.Navigate(HolidayUri);
        }
        ...
        private void AbsencesAppBarButton_Click(object sender, RoutedEventArgs e)
        {
            WebViewControl.Navigate(AbsenceUri);
        }
    }
}
